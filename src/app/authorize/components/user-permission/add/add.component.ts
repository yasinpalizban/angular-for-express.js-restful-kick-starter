...
export class AddComponent implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    ...
    this.userPermissionService.nestedUrl(this.formGroup.value.permissionId).save(userPermission);
  ...
  onChangeGroup(value: any): void {
    ...
    const queryParam = new HttpParams().append('group', JSON.stringify(search));
    const params: IQuery = {
      q: queryParam
    };
