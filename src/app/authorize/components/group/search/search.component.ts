...
export class SearchComponent implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    ...
    this.subscription = this.groupService.getQueryArgumentObservable().subscribe((qParams: IQuery) => {
  ...
  onSubmitAdvanceSearch(): void {
    this.subscription = this.groupService.getQueryArgumentObservable().subscribe((qParams) => {
